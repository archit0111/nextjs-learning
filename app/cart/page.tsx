...
export default function Cart(){
    ...
    return(
        ...
        <div className="text-2xl font-bold mt-10 ml-10">Cart</div>
        <div className="p-4 place-items-center grow mt-40">
            ...
            :<div className={`grid ${[products.length==1?null:"grid place-items-center sm:grid-cols-2 gap-10"]} gap-10`}>{(products.map((item:any)=>(
