            ...
            :<div className="grid sm:grid-cols-2 gap-10">{(products.map((item:any)=>(
                ...
                <div className="pt-2 pl-2">
                    ...
                    <div className="text-center p-2">
                        ...
                        <button className="w-full p-1 rounded-2xl mt-2 bg-pink-200 hover:bg-pink-400 transition-all hover:scale-95 duration-400" onClick={()=>(handelRemoveFromWishlist(item._id))}>Add to wishlist</button>
                    </div>
            </div>
            )))}</div>}
        </div>
