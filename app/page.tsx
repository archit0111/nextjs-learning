            ...
            <div className="h-fit p-5 m-5 rounded-2xl sm:w-[75%] w-min place-self-center bg-olive-300">
                ...
                <form>
                    <div  className="place-self-center">
                        ...
                        <input type="email" className="border p-1 px-1  rounded" placeholder="example@gmail.com" onChange={(e)=>setEmail(e.target.value)} />
                    </div>
                    <div className="flex w-full items-center sm:gap-4 gap-2 pl-[5%] mb-4">
